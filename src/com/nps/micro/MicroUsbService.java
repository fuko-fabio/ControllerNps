...
public class MicroUsbService extends Service {
	...
	public class LocalBinder extends Binder {
		public MicroUsbService getService() {
			return MicroUsbService.this;
		}
    ...
    private void showNotification() {
		...
		notification.setLatestEventInfo(this,
				getText(R.string.local_service_notification), text, contentIntent);
